...
// ═══ NAMES ═══
export const HN=['Kai','Mira','Soren','Lena','Dev','Priya','Tomás','Asha','Reese','Yuki','Omar','Zara','Nadia','Felix','Robin','Clara'];
...
// ═══ ALIEN COLORS (bright, saturated, obviously not human) ═══
export const AC=['#3ddc84','#00e5ff','#d050ff','#ff6090'];

// ═══ BUSINESS SUIT PALETTES ═══
export const BP2=[
  {b:'#2a1810',h:'#e8c898',cl:'#2e3c4a',sh:'#1e2c3a'},
  {b:'#1a1a28',h:'#d4a878',cl:'#3a3040',sh:'#2a2030'},
  {b:'#4a3020',h:'#f0d0a8',cl:'#1e3028',sh:'#142018'},
  {b:'#5a3a1a',h:'#c49870',cl:'#4a3a2a',sh:'#3a2a1a'},
  {b:'#1a1218',h:'#f5d0b0',cl:'#3a2a3a',sh:'#2a1a2a'},
  {b:'#2a2028',h:'#c08868',cl:'#2a3a48',sh:'#1a2a38'},
];

// ═══ APPEARANCE PALETTES (for casual humans & indoor construction) ═══
export const SKIN_TONES=['#f5d0b0','#e8c8a0','#d4a878','#c08050','#8a6040','#604030'];
export const HAIR_COLORS=['#1a1008','#2a1810','#4a3020','#6a4828','#907040','#c09050','#b03020','#e0c080'];
export const MALE_HAIR=['short','buzz','messy','short','buzz'];
export const FEMALE_HAIR=['long','ponytail','bun','bob','short'];
export const CASUAL_TOPS_M=['#5a7a9a','#7a5a4a','#4a6a5a','#555a65','#8a7a6a','#5a6878','#6a6a6a','#70805a'];
export const CASUAL_TOPS_F=['#7a5a6a','#5a7a8a','#8a6a5a','#6a8a7a','#9a6a7a','#6a6a8a','#7a8a6a','#887068'];
export const BOTTOMS=['#3a4555','#4a4040','#2a3a4a','#484848','#3a3a50','#454a3a'];
export const SHOES=['#2a2a2a','#3a2a20','#4a4040','#252525'];

// ═══ APPEARANCE GENERATOR ═══
export function genAppearance(pk,isFem){
  return {
    skin:pk(SKIN_TONES),
    hair:pk(HAIR_COLORS),
    hs:pk(isFem?FEMALE_HAIR:MALE_HAIR),
    top:pk(isFem?CASUAL_TOPS_F:CASUAL_TOPS_M),
    bot:pk(BOTTOMS),
    sho:pk(SHOES),
    fem:isFem
  };
...
// ═══ DIALOGUE: CASUAL HUMANS ═══
export const HM=[
  [n=>`${n} nods. "Hey."`,n=>`"You work on this floor? I keep getting lost."`,n=>`"I've been taking the stairs. The elevator line is insane."`],
...
export const BM=[
  ...
  [n=>`"Have you tried the coffee yet?" ${n} asks.`,n=>`"Don't. It's from a machine on floor one and it tastes like it traveled here by foot."`,n=>`"Someone's bringing a French press tomorrow. I'm treating it like a national holiday."`],
...
// ═══ DIALOGUE: CONSTRUCTION WORKERS (ROOFTOP) ═══
export const CWM=[
...
export const CWM_INDOOR=[
  [n=>`${n} is measuring something. "Hold on."`,n=>`"This wall was supposed to be twelve feet. It's eleven eight."`,n=>`"Close enough for government work. Not close enough for space work."`],
  [n=>`"Careful, wet paint," ${n} warns.`,n=>`"Third coat. First two were the wrong shade. Someone picked 'eggshell' but meant 'ivory.'"`,n=>`"I know seven kinds of white now. I didn't ask to know seven kinds of white."`],
  [n=>`${n} is pulling cable through the ceiling.`,n=>`"Wiring this floor for the new server room. Or the gym. They keep changing their minds."`,n=>`"Doesn't matter to me. Wire goes where wire goes."`],
  [n=>`"Don't touch that panel," says ${n}.`,n=>`"Electrical's half done on this floor. We're working around the office people."`,n=>`"They complained about the drilling. During work hours. In an unfinished building."`],
